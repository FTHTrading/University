...
const articles: BlogArticle[] = [
  // ── Article 1 ──────────────────────────────────────────────────────────────
  {
    ...
    citations: [
      { id: "1", text: "Sinclair, M. (2025). \"Constitutional Frameworks for AI Governance in Higher Education.\" Fitzherbert Review of Constitutional Studies, Vol. CXIII, No. 2, pp. 145–178." },
      ...
      { id: "3", text: "Fitzherbert University Office of Institutional Integrity. (2025). Annual AI Governance Report. Heritage Hall." },
    ],
  },
  ...
  // ── Article 2 ──────────────────────────────────────────────────────────────
  {
    ...
    citations: [
      ...
      { id: "2", text: "Fitzherbert University Athletics Intelligence Division. (2025). Season Performance Analytics Report. Heritage Athletic Complex." },
    ],
  },
  ...
  // ── Article 3 ──────────────────────────────────────────────────────────────
  {
    ...
    citations: [
      { id: "1", text: "Fitzherbert University Finance & Endowment Committee. (2025). Annual Stewardship Report FY 2025. Heritage Hall." },
      { id: "2", text: "Office of the Bursar. (2025). Endowment Ten-Year Performance Review. Fitzherbert University." },
      { id: "3", text: "Fitzherbert University Senate. (2023). Ethical Investment Framework. Published under the Transparency Mandate of 2003." },
    ],
  },
  ...
  // ── Article 4 ──────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      {
        question: "How does Fitzherbert University ensure knowledge provenance?",
        answer:
  ...
  // ── Article 5 ──────────────────────────────────────────────────────────────
  {
    ...
    citations: [
      ...
      { id: "2", text: "Fitzherbert University Esports Analytics Laboratory. (2025). Competitive Intelligence Framework v2.0. Athletics Intelligence Division." },
    ],
  },
  ...
  // ── Article 6 ──────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { question: "What is the 2003 Transparency Mandate?", answer: "A charter amendment requiring all Fitzherbert University governance decisions, financial reports, and policy changes to be published openly. When applied to AI, it mandates publication of model validation reports, bias audits, and deployment decisions." },
    ],
    citations: [
      { id: "1", text: "Langford, V. (2025). \"Constitutional Structures for Algorithmic Governance.\" Yale Law Journal, 134(6), 1420–1478." },
      { id: "2", text: "Fitzherbert University Senate. (2003). Transparency Mandate — Charter Amendment IV." },
    ],
  },
  ...
  // ── Article 7 ──────────────────────────────────────────────────────────────
  {
    ...
    citations: [
      ...
      { id: "2", text: "Fitzherbert University Finance & Endowment Committee. (2025). Distribution Policy Framework: Actuarial Review." },
    ],
  },
  ...
  // ── Article 8 ──────────────────────────────────────────────────────────────
  {
    ...
    citations: [
      ...
      { id: "2", text: "Fitzherbert University Athletics Intelligence Division. (2025). Simulation Engine Validation Report: Three-Year Retrospective." },
    ],
  },
  ...
  // ── Article 9 ──────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { question: "How does Fitzherbert University's knowledge graph work?", answer: "The institutional knowledge graph contains 2.3 million nodes and 8.7 million edges, covering research output, governance decisions, personnel, and facilities. It uses a 47-entity-type ontology aligned with Schema.org and VIVO standards, enabling complex institutional intelligence queries." },
    ],
    citations: [
      ...
      { id: "2", text: "Fitzherbert University Office of Institutional Research. (2025). Knowledge Graph Architecture: Technical Specification v2.0." },
    ],
  },
  ...
  // ── Article 10 ─────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      { question: "Does Fitzherbert University use AI in admissions?", answer: "Predictive analytics may assist but never replace human judgment in admissions. Models serve as one input in holistic review. No applicant may be rejected by algorithmic assessment alone, and all admissions models undergo four-gate validation including bias auditing." },
    ...
    citations: [
      ...
      { id: "2", text: "Fitzherbert University Admissions Office. (2025). Annual Algorithmic Impact Report FY 2025." },
    ],
  },
  ...
  // ── Article 11 ─────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      { heading: "Ethical Framework for Athlete Monitoring", content: "The collection of biomechanical data raises privacy and consent concerns. Fitzherbert University's athletics monitoring programme operates under strict ethical guidelines: athletes provide informed consent, data is used solely for injury prevention and performance optimization, and no biomechanical data may be shared with recruitment or coaching staff without the athlete's explicit approval. Data governance follows the same constitutional principles applied to institutional AI." },
    ],
    faq: [
  ...
  // ── Article 14 ─────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { question: "How many documents are in Fitzherbert University's vector database?", answer: "The current system contains 4.2 million chunks representing 98% of the University's documentary output since 1903, including research papers, governance records, policy documents, and institutional correspondence." },
    ],
    citations: [
      ...
      { id: "2", text: "Fitzherbert University IT Division. (2025). Vector Database Architecture: Implementation Report v1.0." },
    ],
  },
  ...
  // ── Article 15 ─────────────────────────────────────────────────────────────
  {
    ...
    citations: [
      { id: "1", text: "Fitzherbert University Office of the Chancellor. (2026). \"Governance Design and Institutional Resilience: A 243-Year Case Study.\" Published in the University Record." },
      ...
      { id: "3", text: "Fitzherbert University Senate. (2024). Charter Amendment V — Constitutional Framework for AI Governance." },
    ],
  },
];
