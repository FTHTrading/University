...
export const authors: Record<string, Author> = {
  "margaret-sinclair": {
    ...
    affiliation: "Centre for Artificial Intelligence & Ethics, FTHTrading University",
    ...
    url: "https://fthtrading.university/academics#faculty",
  },
  "victoria-langford": {
    id: "victoria-langford",
    name: "Professor Victoria Langford",
    title: "Dean, School of Law & Constitutional Studies",
    affiliation: "School of Law & Constitutional Studies, FTHTrading University",
  ...
  "richard-pemberton": {
    ...
    affiliation: "Graduate School of Commerce & Strategy, FTHTrading University",
  ...
  "james-harrington": {
    ...
    affiliation: "School of Engineering & Applied Science, FTHTrading University",
  ...
  "editorial-board": {
    ...
    affiliation: "FTHTrading University",
    ...
    url: "https://fthtrading.university/about",
  },
};
